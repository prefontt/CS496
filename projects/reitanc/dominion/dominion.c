...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if(card == adventurer) ? return playAdventurer(struct gameState *state) : continue;
  if(card == smithy) ? return playSmithy(state, handPos) : continue;
...
int playVillage(struct gameStationse *state, int handPos){}
